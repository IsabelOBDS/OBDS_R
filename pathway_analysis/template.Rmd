...
all_genes_df <- read.csv("/project/obds/imorgan/2_r/projects/DESeq2_tutorial/CD8_vs_CD4_DE_results_lfcshrinkage_allgenes.csv")
...
all_gene_ids <- all_genes_tested_df$sample_ID
    
upreg_gene_ids <- upreg_genes_df$sample_ID
    
downreg_gene_ids <- downreg_genes_df$sample_ID
```
